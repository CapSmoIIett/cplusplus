...
В set_exception можно передавать результаты функций:
std::current_exception(), которая возвращает последнее возбужденное исключение
std::copy_exception(), чтобы поместить в объект обещание новое исключение, которое никем не возбуждалось.
